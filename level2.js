var Level2 = {
	...
	preload: function(){
        ...
        game.load.image('meteor', '/assets/enemies/meteor.png');
        ...
        game.load.image('health_up', 'assets/bullets/health.png');
        
        //loading background music
        game.load.audio('level2music', 'assets/sounds/level2.mp3');
        game.load.audio('bossmusic', 'assets/sounds/boss.mp3');
        game.load.audio('end', 'assets/sounds/endlevel.mp3');

        
        //loading sound effects
        game.load.audio('laser', 'assets/sounds/laser.mp3');
        game.load.audio('weapon_upgrade', 'assets/sounds/weapon_upgrade.mp3');
        game.load.audio('health_sound', 'assets/sounds/health.mp3');
        game.load.audio('player_dead', 'assets/sounds/player_dead.mp3');
        game.load.audio('enemydie', 'assets/sounds/enemydie.mp3');
        game.load.audio('meteor_colide', 'assets/sounds/enemydie2.mp3');
        game.load.audio('hit', 'assets/sounds/error.mp3');
        game.load.audio('beam', 'assets/sounds/beam.mp3');
    ...
    update: function() {
        ...
        if (score >= scoreStep) {
            launchBulletUpgrade();
            scoreStep = scoreStep + score;
        }

        if (score >= meteorStep) {
            launchMeteor();
            meteorStep = meteorStep + score;
        }

        if(score >= healthStep){
            launchHealth();
            healthStep = healthStep + score;
        }
